// Platform-agnostic core for the bug reporter.
// Both bug-reporter.ts (native) and bug-reporter.web.ts re-export from here,
// then add their own storage factory. This avoids a Metro require-cycle that
// would otherwise occur because `export * from './bug-reporter'` resolves
// back to the web file on web.
